...
public class Question1 {
    /*
      ...
      2-Get the sum of two digits and return true(if it's matching) or false(if it's not matching)
      ...
      Output=False;
    */
    // First of all I will need to reach out to each of the number1
    // I need to add them and then compare with number2
    public static void main(String[] args) {
        int number1=45767;
        int number2=21;    // try both 12 and 21 and then run
