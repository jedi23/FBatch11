...
public class TernaryPractice {
    public static void main(String[] args) {
       ...
       // (if condition 5==5 is true go to ? block condition, otherwise go to : block condition)
        ...
        String result5 = str.substring(3).equals("id") ?  str.toLowerCase().concat(" is number") :
                str.toUpperCase().concat(" is String");

        System.out.println(result5);

        System.out.println(str.equalsIgnoreCase("David") ? str.substring(3).toUpperCase() :
