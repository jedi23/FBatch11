...
public class Hired {
    public static void main(String[] args) {
        /*
         ==Task== nested if >>>> java>selenium>API>Sql
         ask user:
        ...
        } else { // this is for Java response
            System.out.println("We need someone with Java experience, you should learn at least 1 programming language");
        }
    }
}
