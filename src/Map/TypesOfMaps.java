...
public class TypesOfMaps {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(drinks1);  // HashMap, random order
        System.out.println(drinks2);  // LinkedHashMap, In order of entry as entered
        System.out.println(drinks3);  // TreeMap, Ascending Order, cannot have null value for TreeMap
